...
namespace CareerCloud.BusinessLogicLayer
{
    public class ApplicantWorkHistoryLogic : BaseLogic<ApplicantWorkHistoryPoco>
    {
        ...
        {
            ApplicantWorkHistoryPoco poco = base.GetAll().Where(s => s.Login == userName).FirstOrDefault();
            if (null == poco)
            {
                return false;
            }
        ...
        protected override void Verify(ApplicantWorkHistoryPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(105, $"Company name {poco.Company_Name} must be greater than 2 characters"));
                }                
            }
